...
def extract_pubmed_articles_to_txt(input_dir, output_dir):
    """
    Extracts ArticleTitle and AbstractText from multiple XML.GZ files
    and combines them into a single TXT file, removing HTML tags.
    """        
...
# python3 prep_data_pubmed.py test        testTXT
# python3 prep_data_pubmed.py baseline    baselineTXT 
# python3 prep_data_pubmed.py updatefiles updatefilesTXT
